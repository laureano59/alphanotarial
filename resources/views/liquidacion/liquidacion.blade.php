                                          ...
                                          <form id="formliq">
                                            ...
                                            <div class="inner_table">
                                                <table class="table table-striped table-bordered table-hover" style="border-collapse: collapse;">
                                                    ...
                                                    <tr id="{{$con->atributo}}" style="display: none; line-height: 1; height: 30px;">
                                                        <td width="50%" style="padding: 1px;">
                                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 
                                                                <b class="blue">{{$con->nombre_concep}}</b> 
                                                            </label>
                                                        </td>
                                                        <td width="25%" style="padding: 1px;">
                                                            <input type="text" id="hojas{{$con->atributo}}" class="col-xs-10 col-sm-8" 
                                                            onblur="InputTexto(this.id, {{$con->id_concep}})" 
                                                            onKeyPress="return soloNumeros(event)" value="0" style="height: 25px;" />
                                                        </td>
                                                        <td width="25%" style="padding: 1px; vertical-align: middle;">
...
<tr id="timbredecreto175" style="display:none">
  <td><b class="blue">Timbre Decreto 175</b></td>
  <td>
      <b class="green"><span id="totaltimbrec"></span></b>
      <input type="hidden" id="totaltimbredecreto175" value="0">
  </td>
