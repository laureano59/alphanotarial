...
<div class="page-header">
    <h1>Modulo de Cartera Caja Rápida</h1>
</div><!-- /.page-header -->
<form>
    @csrf
            ...
            <div class="widget-box">
                <div class="widget-header">
                    <div class="widget-toolbar">
                        <a href="/imprimirabonoscajarapida" target="_blank">
...
<script src="{{ asset('js/caja_rapida/cartera/script.js')}}"></script>
<script src="{{ asset('js/cartera/grid_cartera.js')}}"></script>
@endsection
