...
<body>
    ...
    <table width="100%">
        <tr>
            ...
            <td width="25%"></td>
            <td width="20%">
                <font size="1"><b>Recibo de Caja</b></font>
            </td>
            <td width="25%"><b>No.&nbsp;-&nbsp;{{$num_fact}}</b></td>
        </tr>
        <tr>
            <td width="30%">
...
@if (isset($contdeducciones))
  ...
  @endif
    ...
    <hr>
    <font size="1" >Observaciones: En el transcurso del día le llegará a su correo la factura electrónica.</font>
    <br>
    <table width="100%">
      <tr>
        <td>
