...
<body>
    <table width="100%">
        <tr>
            ...
            <td>
                <img src="{{ asset('images/logon13.png') }}" width="85px" height="85px">
                </br>
                <center>{{$email}}</center>
            </td>
        </tr>
    ...
    <table width="100%">
        <tr>
         ...
         <tr>
            ...
            <td width="25%"></td>
            <td width="20%">
                <font size="4"><b>Otorgante:</b></font>
            </td>
            <td width="25%" align="right">
                <font size="4"><b>$&nbsp;{{ number_format($total_otorgante, 2) }}</b></font>
            </td>
        </tr>
         ...
         <tr>
            ...
            <td width="25%"></td>
            <td width="20%">
                <font size="4"><b>Compareciente:</b></font>
            </td>
            <td width="25%" align="right">
                <font size="4"><b>$&nbsp;{{ number_format($total_compareciente, 2) }}</b></font>
            </td>
        </tr>
    </table>
